# Balance Studio — Manual de Instalación

Este manual contiene instrucciones sencillas y muy detalladas para instalar y configurar el sistema **Balance Studio** en una computadora con Windows utilizando **Laragon**.
...
1. **Laragon WAMP** (Recomendado versión 6.0 o superior).
   - Descárgalo de: [https://laragon.org/download/](https://laragon.org/download/)
   - El instalador debe incluir:
     - **Apache 2.4**
     - **PHP 8.1** o superior
     - **MySQL 8.0** o superior
2. El código fuente completo del proyecto **Balance Studio**.
3. Permisos de Administrador en el sistema operativo Windows.
...
5. La ruta final exacta de los archivos debe ser: `C:\laragon\www\balancebarre\`. Asegúrate de que los archivos principales como `index.php` y `login.php` estén directamente en esa carpeta.
...
9. Espera unos segundos hasta que se complete la ejecución del script. Verás las tablas creadas (`alumnas`, `coaches`, `horarios`, etc.) en el panel izquierdo. Ya puedes cerrar HeidiSQL.
